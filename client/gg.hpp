...
namespace GG {
// for ftxui
enum class ScreenState { MainMenu, DocumentationMenu, FunctionMenu, Exit };
...
class Client {
  public:
    ...
    // uploads a video located at the given path encrypting with the given
    // password
  ...
  private:
    ...
    void _populate_color_lookup_table(CharFormat *color_lookup_table, ColorSchemeKind kind, size_t num_colors,
